...
test.describe('chrome extension tests', () => {
  ...
  test.describe('Popup', () => {
    test.only('title', async () => {
      ...
      await xpo.activate();
      await expect(await extPage.screenshot()).toMatchSnapshot('landing-page.png', { maxDiffPixelRatio: 0.15 });
      ...
      await expect(await extPage.screenshot()).toMatchSnapshot('with-mock.png', { maxDiffPixelRatio: 0.15 });
