...
import { REQUIRED_MSG, STATUS_CODE_EXISTS_MSG, STATUS_CODE_INVALID_MSG } from '@shared/constants';
...
export class CreateStatusCodeComponent {
  public error: string;
  public statusCodeControl = new FormControl('', [Validators.required, statusCodeValidator(this.input.existingStatusCodes)]);
